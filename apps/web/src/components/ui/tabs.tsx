...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn("anim-fade-in flex-1 outline-none", className)}
      {...props}
    />
  )
}
