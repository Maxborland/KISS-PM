 ...
 * срок, сумма, план.часы, спрос (позиция · часы). Фильтр «Все/Активные» —
 * контракт GET /api/workspace/projects отдаёт только активные, поэтому «Все» —
 * демо-переключатель. Карточка проекта — отдельный экран (навигация не
