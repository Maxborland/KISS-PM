...
const routeDocs: RouteDoc[] = [
  ...
  { method: "post", path: "/api/workspace/projects/:projectId/planning/forecast-runs", tag: "Planning", summary: "Create plan forecast run", requestSchema: "PlanningForecastRunCreateRequest", successSchema: "PlanningForecastRunResponse" },
  { method: "get", path: "/api/workspace/projects/:projectId/planning/forecast-runs/:runId", tag: "Planning", summary: "Read plan forecast run", successSchema: "PlanningForecastRunResponse" },
