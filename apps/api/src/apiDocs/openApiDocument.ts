...
const routeDocs: RouteDoc[] = [
  ...
  { method: "patch", path: "/api/workspace/crm/pipelines/:pipelineId", tag: "CRM", summary: "Update CRM pipeline", requestSchema: "CrmPipelineWriteRequest", successSchema: "CrmPipelineResponse" },
  ...
  { method: "patch", path: "/api/workspace/crm/pipelines/:pipelineId/stages/:stageId", tag: "CRM", summary: "Update CRM pipeline stage", requestSchema: "CrmPipelineStageWriteRequest", successSchema: "CrmPipelineStageResponse" },
  ...
  { method: "patch", path: "/api/workspace/crm/pipelines/:pipelineId/transition-rules/:ruleId", tag: "CRM", summary: "Update CRM pipeline transition rule", requestSchema: "CrmPipelineTransitionRuleWriteRequest", successSchema: "CrmPipelineTransitionRuleResponse" },
  ...
  { method: "patch", path: "/api/workspace/crm/pipelines/:pipelineId/automations/:automationId", tag: "CRM", summary: "Update CRM pipeline stage automation", requestSchema: "CrmPipelineStageAutomationWriteRequest", successSchema: "CrmPipelineStageAutomationResponse" },
