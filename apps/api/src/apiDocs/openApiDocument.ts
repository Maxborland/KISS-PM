...
const routeDocs: RouteDoc[] = [
  ...
  { method: "get", path: "/api/tenant/current/audit-learning-inputs", tag: "Audit", summary: "List audit learning inputs", successSchema: "AuditLearningInputsResponse", queryParameters: [{ name: "limit", in: "query", required: false, schema: { type: "integer", minimum: 1, maximum: 100, default: 100 } }] },
  ...
  { method: "get", path: "/api/workspace/project-task-stages", tag: "Projects and tasks", summary: "List project task stages", successSchema: "ProjectTaskStagesResponse" },
  { method: "post", path: "/api/workspace/project-task-stages", tag: "Projects and tasks", summary: "Create project task stage", requestSchema: "ProjectTaskStageWriteRequest", successSchema: "ProjectTaskStageResponse", successStatus: 201 },
  { method: "patch", path: "/api/workspace/project-task-stages/:stageId", tag: "Projects and tasks", summary: "Update project task stage", requestSchema: "ProjectTaskStageWriteRequest", successSchema: "ProjectTaskStageResponse" },
  { method: "delete", path: "/api/workspace/project-task-stages/:stageId", tag: "Projects and tasks", summary: "Archive project task stage", body: "none", successSchema: "ProjectTaskStageResponse" },
  ...
  { method: "get", path: "/api/tenant/current/operational-control-queue", tag: "KPI and control", summary: "Read operational control queue", successSchema: "OperationalControlQueueResponse", queryParameters: [{ name: "asOf", in: "query", required: false, schema: { type: "string", format: "date-time" } }, { name: "limit", in: "query", required: false, schema: { type: "integer", minimum: 1, maximum: 100, default: 50 } }] },
  ...
  { method: "post", path: "/api/workspace/call-rooms/:roomId/sessions/:sessionId/screen-share", tag: "Calls", summary: "Update call screen-share metadata", requestSchema: "CallScreenShareStateRequest", successSchema: "CallScreenShareStateResponse" },
