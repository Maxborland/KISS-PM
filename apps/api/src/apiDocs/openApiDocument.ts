...
const routeDocs: RouteDoc[] = [
  ...
  { method: "post", path: "/api/workspace/projects/:projectId/knowledge/documents/:documentId/versions/:versionId/restore", tag: "Knowledge", summary: "Restore project document version", body: "none", successSchema: "KnowledgeDocumentVersionResponse", successStatus: 201 },
  ...
  { method: "delete", path: "/api/workspace/projects/:projectId/knowledge/decisions/:decisionId", tag: "Knowledge", summary: "Delete decision log entry", body: "none", successSchema: "KnowledgeDecisionResponse" },
  ...
  { method: "delete", path: "/api/workspace/projects/:projectId/knowledge/action-items/:actionItemId", tag: "Knowledge", summary: "Delete knowledge action item", body: "none", successSchema: "KnowledgeActionItemResponse" },
