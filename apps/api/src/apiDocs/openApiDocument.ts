...
const routeDocs: RouteDoc[] = [
  ...
  { method: "post", path: "/api/workspace/opportunities/:opportunityId/pipeline-transition", tag: "Project intake", summary: "Transition opportunity CRM pipeline stage", body: "json" },
