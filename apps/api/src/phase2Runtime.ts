...
const phase2PermissionCatalog = [
  ...
  createPermission({
    key: "action.config.write",
    description: "Preview and publish tenant action availability and form configuration",
    category: "control_surfaces"
  }),
  createPermission({
  ...
  createPermission({
    key: "ops.audit.read",
    description: "Read operator audit and smoke command evidence",
    category: "ops"
  }),
  createPermission({
  ...
  createPermission({
    key: "release.readiness.execute",
    description: "Execute Phase 12 release-readiness checks",
    category: "ops"
  })
