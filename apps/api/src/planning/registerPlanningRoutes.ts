...
import { buildCompensatingCommandBatch, buildCompensatingCommands, isBlockingValidationIssue, type PlanningCommand } from "@kiss-pm/domain";
...
import { registerPlanningScenarioRoutes } from "./planningScenarioRoutes";
...
import { denyPlanningAction, emitPlanVersionFromBody, respondFromFailedResult } from "./planningRouteResponders";
...
export function registerPlanningRoutes(app: Hono, deps: PlanningRouteDeps) {
  ...
  registerPlanningScenarioRoutes(app, deps);
