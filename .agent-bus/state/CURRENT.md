...
- `node scripts/verify-requirements-matrix.mjs --allow-blocked docs/status/phase9-requirements-matrix.json` passes with P9-001/P9-003 API/domain evidence. Strict verification intentionally fails until P9 UI/product implementation and E2E-080..083 are complete.
...
- Next recommended step: claim `P9-004-retrospective-plan-fact-trend-engine` and implement deterministic PlanFactMetric/RetrospectiveTrend calculations from immutable ClosedProjectSnapshot source data before P9 portfolio UI/E2E work.
