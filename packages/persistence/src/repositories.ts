...
import { createProjectResourcePoolRepository, type ProjectResourcePoolRepository } from "./projectResourcePoolRepository";
...
export function createPostgresTenantDataSource(
  ...
  return {
    ...
    ...createProjectResourcePoolRepository(db),
