...
45. `44_PHASE_G_3_COMMUNICATIONS_UPGRADE_BACKEND.md` — backend contract для общих каналов, entity/CRM чатов, reactions, emoji, sticker packs/imports, channel-scoped calls и permissioned notifications/audit.
