...
26. `25_CRM_ENTITY_WORKSPACE_TEMPLATE.md` — единый шаблон карточек CRM-сущностей: сделка, клиент, контакт, товар/услуга и future line items.
