...
10. **Deals pipeline runtime evidence**
   - Status: runtime deals pipeline persists stage changes, filters live deals, opens live detail sheet, shows honest no-results state and has desktop/narrow screenshot evidence.
